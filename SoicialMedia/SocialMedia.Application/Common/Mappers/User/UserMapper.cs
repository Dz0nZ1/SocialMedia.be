...
public static partial class UserMapper
{
    ...
    {
        return new UserDetailsDto(entity.FirstName, entity.LastName, entity.Username, entity.ProfilePictureUrl, entity.Bio, entity.Posts.ToDetailsListDto());
    }
    ...
    {
        entity.UpdateUser(dto.FirstName, dto.LastName, dto.Username,
            dto.ProfilePictureUrl, dto.Bio);
    }
